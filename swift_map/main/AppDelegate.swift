...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        let navc = APPNavigationController(rootViewController: AppSingleton.sharedInstance.rootVC);
        
        AppSingleton.sharedInstance.rootNAVC = navc;
        window?.rootViewController = AppSingleton.sharedInstance.rootNAVC;
